...
class Bpc:
    ...
    def set_tile(self, layer: int, index: int, tile_mapping: TilemapEntry) -> None: ...
    ...
    def set_chunk(self, layer: int, index: int, new_tilemappings: Sequence[TilemapEntry]) -> None: ...
