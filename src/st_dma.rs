...
impl Dma {
    ...
    pub fn get(&self, get_type: DmaType, neighbors_same: u8) -> Vec<u8> {
        todo!()
    }
    ...
    pub fn set(&mut self, get_type: DmaType, neighbors_same: u8, variation_index: u8, value: usize) {
        todo!()
    }
